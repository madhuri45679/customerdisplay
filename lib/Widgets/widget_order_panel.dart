          ...
          try {
            ...
            if (cached != null) {
              try {
                ...
                if (kDebugMode) print("⚠️ Failed to parse Hive cache: $e");
              }
            }
            ...
            try {
              ...
              try {
                ...
                if (kDebugMode) print("⚠️ Failed to parse metaData: $e");
              }
              ...
              if (!isProductAgeRestricted) {
                try {
                  ...
                  if (kDebugMode) print("⚠️ Failed to parse tags: $e");
                }
              }
              ...
              if (isProductAgeRestricted) {
                ...
                if (!isOrderAlreadyVerified) {
                  if (kDebugMode)
                    print("⚠️ [AGE VERIFICATION REQUIRED] for '${product.name}'");
              ...
              if (kDebugMode) print("⚠️ Age verification block error: $e");
            }
